                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('posts.store')}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{old('title')}}" class="form-control @if($errors->has('title')) is-invalid @endif"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @if($errors->has('tags')) is-invalid @endif" id="tags"
                                    ...
                                    @foreach($tags as $tag)
                                        <option value="{{$tag->id}}"
                                                @if(old('tags') && in_array($tag->id, old('tags'))) selected @endif>{{$tag->name}}</option>
                                    @endforeach
                                </select>
                                @if($errors->has('tags'))
